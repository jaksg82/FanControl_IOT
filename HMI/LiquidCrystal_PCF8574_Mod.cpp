...
LiquidCrystal_PCF8574_Mod::LiquidCrystal_PCF8574_Mod(int i2cAddr)
{
  _i2cAddr = i2cAddr;
  _backlight = 0;
...
void LiquidCrystal_PCF8574_Mod::begin(int cols, int lines)
{
  // _cols = cols ignored !
  _lines = lines;
...
void LiquidCrystal_PCF8574_Mod::clear()
{
...
void LiquidCrystal_PCF8574_Mod::init()
{
  clear();
} // init()


void LiquidCrystal_PCF8574_Mod::home()
{
...
void LiquidCrystal_PCF8574_Mod::setCursor(int col, int row)
{
...
void LiquidCrystal_PCF8574_Mod::noDisplay()
{
...
void LiquidCrystal_PCF8574_Mod::display()
{
  // Instruction: Display on/off control = 0x08
  _displaycontrol |= 0x04; // display
  _send(0x08 | _displaycontrol);
...
void LiquidCrystal_PCF8574_Mod::cursor()
{
  // Instruction: Display on/off control = 0x08
...
void LiquidCrystal_PCF8574_Mod::noCursor()
{
  // Instruction: Display on/off control = 0x08
  _displaycontrol &= ~0x02; // cursor
  _send(0x08 | _displaycontrol);
...
void LiquidCrystal_PCF8574_Mod::blink()
{
  // Instruction: Display on/off control = 0x08
...
void LiquidCrystal_PCF8574_Mod::noBlink()
{
  // Instruction: Display on/off control = 0x08
  _displaycontrol &= ~0x01; // blink
  _send(0x08 | _displaycontrol);
...
void LiquidCrystal_PCF8574_Mod::scrollDisplayLeft(void)
{
...
void LiquidCrystal_PCF8574_Mod::scrollDisplayRight(void)
{
  // Instruction: Cursor or display shift = 0x10
...
void LiquidCrystal_PCF8574_Mod::leftToRight(void)
{
...
void LiquidCrystal_PCF8574_Mod::rightToLeft(void)
{
...
void LiquidCrystal_PCF8574_Mod::autoscroll(void)
{
...
void LiquidCrystal_PCF8574_Mod::noAutoscroll(void)
{
...
void LiquidCrystal_PCF8574_Mod::setBacklight(int brightness)
{
...
void LiquidCrystal_PCF8574_Mod::createChar(int location, int charmap[])
{
...
inline size_t LiquidCrystal_PCF8574_Mod::write(uint8_t ch)
{
  _send(ch, true);
...
void LiquidCrystal_PCF8574_Mod::_send(int value, bool isData)
{
  // write high 4 bits
...
void LiquidCrystal_PCF8574_Mod::_sendNibble(int halfByte, bool isData)
{
...
void LiquidCrystal_PCF8574_Mod::_write2Wire(int halfByte, bool isData, bool enable)
{
